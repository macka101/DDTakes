...
Public Class AllianceInvoice
    ...
    Private Sub XrLabelAddress_BeforePrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles XrLabelAddress.BeforePrint
